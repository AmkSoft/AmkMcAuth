...
public class AmkAUtils {
    ...
    public static BukkitTask createRegisterReminder(Player p, Plugin pl) {
        return createReminder(p, pl, ChatColor.RED + Language.PLEASE_REGISTER_WITH.toString() + " " + ChatColor.GRAY + "/register [password]" + ChatColor.RED + "!", Config.remindInterval * 20L);
    }

    public static BukkitTask createLoginReminder(Player p, Plugin pl) {
        return createReminder(p, pl, ChatColor.RED + Language.PLEASE_LOG_IN_WITH.toString() + " " + ChatColor.GRAY + "/login [password]" + ChatColor.RED + "!", Config.remindInterval * 20L);
    }
